...
class Book{
  ...
  final books = [
    ...
    Book(
      ...
      longDescription:"Kambili's father Eugene is a man of enormous contradictions — a celebrated pro-democracy newspaper publisher, a generous philanthropist, a devout Catholic, and at home, a tyrant whose love expresses itself in violence and control. Kambili has learned to move through her own house in silence. Then she and her brother are sent to stay with their Aunt Ifeoma in Nsukka, and she encounters for the first time a family that laughs, argues, and loves loudly. Chimamanda Ngozi Adichie's debut novel is quiet and devastating — a story about the slow, terrifying process of learning that the world is larger than the one you were handed.",
      genre:"Literary Fiction, African Literature",
      rating:4,
    ),
    Book(
    ...
    Book(
      ...
      longDescription: "In the Republic of Gilead, women have been stripped of their names, their rights, and their identities. Offred is a Handmaid — her only permitted role is to bear children for the Commander and his wife. She remembers a different life. She is trying to survive this one. Margaret Atwood's 1985 novel is not science fiction so much as it is a extrapolation of history — every horror in it has a precedent somewhere in the world. What makes it devastating is not the dystopia itself but Offred's voice: wry, precise, grief-soaked, and stubbornly human. It has never felt more relevant than it does right now.",
